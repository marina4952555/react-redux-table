...
import { getFilteredTableData } from '../../redux/tableData/thunks';
import './index.css';
...
function Search() {
  ...
  const onClickHandleSearch = (searchText: string) => {
    dispatch(getFilteredTableData(searchText));
  };
  ...
  return (
    <form>
      ...
      <button type='button' onClick={() => onClickHandleSearch(searchText)}>
